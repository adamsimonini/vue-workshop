<template>
  <div class="emitting">
      ...
      <p>
          ...
          Children can have easy access to the parent component's state through props. However, updaing the state of the child to the parent is a bit more explicit & cumbersome.
      </p>
      ...
      <p>
          <ol>
              ...
              <li>When the parent detects "clickedSomething", it runs its won function in response (which in this case is "handleCLickInParent"</li>
      ...
      <p>
          ...
          Now checkout this page (Emitting.vue) to see steps 4-6. The instance of "Sources" on this page listens for the event "passURL", and it triggers a function on this 
          page (the parent page). That function simply logs the url plus a little extra message added from the child. Success! The parent has received data from the child.
      </p>
...
export default {
  ...
  methods: {
      handleURL: function (url) {
          console.log('%c' + url, "color: #42b883;")
      }
  }
}
</script>
